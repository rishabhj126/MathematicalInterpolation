...
public final class InterpolatorView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        drawline(canvas, Color.DKGRAY, -2, 0, 2, 0);
        ...
        drawText(canvas, Color.BLACK, "0", 0, 0, 0, paint.getTextSize());
        drawText(canvas, Color.BLACK, "1", 1, 0, 0, paint.getTextSize());
        drawText(canvas, Color.BLACK, "1", 0, 1);
        ...
        if (position >= 0) {
            ...
            canvas.drawCircle(converter.toScreenX(-0.5f), converter.toScreenY(1f), 50, paint);
        }
    }
